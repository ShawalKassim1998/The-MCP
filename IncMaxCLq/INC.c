...
static inline int exclude_noneibor(int noneibor, int reason_iset) {
  int my_iset;
...
/*   mess=times(a_tms); begintime = a_tms->tms_utime; */
  ...
  printf ("Program terminated in %f seconds.\n",
	  ((float)(clock() - starttime.ru_utime.tv_sec))/CLOCKS_PER_SEC);
